...
//    if (!((isteacherinanycourse($user1->id)||isteacherinanycourse($user2->id)))) {
// 	$messageerror = "Sólo puede enviar mensajes a profesores";
//    } 

/*
echo "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!";

    $kevcontext = get_context_instance(CONTEXT_SYSTEM);
    $kevroles = get_user_roles($kevcontext,$user1->id);
    $messageerror = var_export($kevroles);
// $messageerror = "Hi";
*/
//$kevUser1IsTeacher = user_has_role_assignment($user1->id,3);
//$kevUser2IsTeacher = user_has_role_assignment($user2->id,3);
...
/*else if (user_has_role_assignment($user1->id,1))
	$messageerror = "user1 has role 1";
else if (user_has_role_assignment($user1->id,2))
	$messageerror = "user1 has role 2"; 
else if (user_has_role_assignment($user1->id,3))
        $messageerror = "user1 has role 3";
else if (user_has_role_assignment($user1->id,4))
        $messageerror = "user1 has role 4";
else if (user_has_role_assignment($user1->id,5))
        $messageerror = "user1 has role 5";
else if (user_has_role_assignment($user1->id,6))
        $messageerror = "user1 has role 6";           
else if (user_has_role_assignment($user1->id,7))
        $messageerror = "user1 has role 7";  
else $messageerror = "not role 0-7";
*/
// HACK FINISH
